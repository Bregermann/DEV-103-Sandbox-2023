...
//     version 1.4.1
//     from Assets/MechCombatKit/UniversalVehicleCombat/InputSystem/LoadoutInputAsset.inputactions
//
    ...
    public struct LoadoutControlsActions
    {
        ...
        public void SetCallbacks(ILoadoutControlsActions instance)
        {
            if (m_Wrapper.m_LoadoutControlsActionsCallbackInterface != null)
            {
                ...
                @LookEngage.started -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnLookEngage;
                @LookEngage.performed -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnLookEngage;
                @LookEngage.canceled -= m_Wrapper.m_LoadoutControlsActionsCallbackInterface.OnLookEngage;
            }
